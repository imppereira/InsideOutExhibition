...
function onLoadVisualization() { //chamada no geral.js
    //MAPA--------------------------------------------------------------------------------------------------------------------------------
    ...
    Object.keys(data).forEach((element, index) => {
            ...
            let moduloVis = svg.append('g')
                ...
                .on('mouseover', function () {
                    ...
                    specie_name_botanico.innerHTML = data[Number(index)].nome_pt;
                })
                //QUANDO NÃO HÁ HOVER
                ...
                .on('click', function () {
                    ...
                    click_nomePTSpecie.innerHTML = data[Number(index)].nome_pt;
                    ...
                    click_regiaoSpecie.innerHTML = data[Number(index)].regiao_pt;
                    let click_idadeSpecie = document.getElementById("click_idadeSpecie");
                    if (data[Number(index)].idade_max != null) {
                        click_idadeSpecie.innerHTML = data[Number(index)].idade_max + " anos";
                    } else {
                        click_idadeSpecie.innerHTML = "Indefinido";
                    }
                    let click_larguraSpecie = document.getElementById("click_larguraSpecie");
                    if (data[Number(index)].largura_media != null) {
                        click_larguraSpecie.innerHTML = data[Number(index)].largura_media + " metros";
                    } else {
                        click_larguraSpecie.innerHTML = "Indefinido";
                    }
                    let click_alturaSpecie = document.getElementById("click_alturaSpecie");
                    if (data[Number(index)].altura_media != null) {
                        click_alturaSpecie.innerHTML = data[Number(index)].altura_media + " metros";
                    } else {
                        click_alturaSpecie.innerHTML = "Indefinido";
                    }
                    let click_grupoSpecie = document.getElementById("click_grupoSpecie");
                    click_grupoSpecie.innerHTML = data[Number(index)].tipo_arvore;
                    let click_folhaSpecie = document.getElementById("click_folhaSpecie");
                    click_folhaSpecie.innerHTML = data[Number(index)].tipo_folha;
                    let click_dioicaSpecie = document.getElementById("click_dioicaSpecie");
                    click_dioicaSpecie.innerHTML = data[Number(index)].dioica;
...
function drawGrafico(index, idContainer, dados) {
    ...
    let message = svgIdade.append('text')
        .text("Ao passar o rato por cima das barras, poderás comparar valores")
        .attr('x', widthSVG2 / 2)
        .attr('y', -20)
        .attr("fill", "#333333")

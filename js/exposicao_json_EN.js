function exposicao_json(indice) { //ALTEREI exposicao_json_EN
// var specie_image_anatomy = document.getElementById("specie_image_anatomy"); NA PÁGINA NO_JBUC
    //var specie_image_jbuc = document.getElementById("specie_image_jbuc");
...
//FICHEIRO DE CSV PARA OS RESTANTES DADOS
    function functionSpeciesContainers() {
        ...
        //Nome EN
        specie_name.innerHTML = data[indice].nome_en;
        //Região
        specie_region.innerHTML = data[indice].regiao_en;
        //Text
        specie_text_p1.innerHTML = data[indice]["textos"].en_p1;
        specie_text_p2.innerHTML = data[indice]["textos"].en_p2;
        if (data[indice]["textos"].en_p3 !== " ") {
            specie_text_p3.innerHTML = data[indice]["textos"].en_p3;
        }
        ...
        specie_image_anatomy_button.src = "/assets/img/specie_image_anatomy/button_en/Sp" + [indice + 1] + "_2000_button.png";
